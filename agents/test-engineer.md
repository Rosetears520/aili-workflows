...
- **Do not invoke from another persona.** Recommendations for implementation, review, or security work belong in your report; MainAgent or a slash command decides when to act.