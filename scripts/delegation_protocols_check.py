...
CONTENT_CHECKS = {
    ...
    "agents/code-scout.md": ["## Role", "compact locality map", "Do not plan, review, implement, or edit research sources", "only the explicitly authorized designated-report exception may permit a write", "effective parent, role/backend, and exact path permissions are all required", "## Output"],
