...
def validate_define_artifact_contracts() -> list[str]:
    ...
    required_markers = {
        ...
        ".agents/skills/requirements-grilling/SKILL.md": [
            ...
            "when writing is permitted, merge the user's accepted answer, accepted default, explicit waiver, or named `UNVERIFIED` state into `interview.md`",
            "re-read once before formal classification or write-back",
            ...
            "Under no-write, analyze the answer in chat without formal writeback or advancement",
