...
| `/ship` | SHIP | Reuse or refresh BUILD gates, run release-blocker audit for the selected change/final diff or explicitly requested baseline/repository scope, then complete release-readiness review, repair, verification, archive/sync/closeout as approved. |
