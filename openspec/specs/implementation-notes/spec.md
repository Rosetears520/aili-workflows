# implementation-notes Specification

## Purpose

Require a lightweight, human-readable implementation rationale trail during approved spec-backed implementation work across OpenSpec, Superpowers-style, and custom spec backends.
