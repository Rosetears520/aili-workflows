# explain-by-allegory Specification

## Purpose

Provide a reusable explanation workflow that teaches complex concepts through allegory, then maps the allegory back to formal concepts, limits, and next steps.
