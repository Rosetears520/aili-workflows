# agent-operating-discipline Specification

## Purpose

Strengthen generated-project agent operating discipline with compact execution-time guardrails, DCP-aware continuity checkpoints, and implementation notes requirements.
