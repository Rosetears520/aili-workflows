...
| Skill | 说明 |
|---|---|
| `aili-delivery-flow` | AILI 交付生命周期权威：IDEATE、DEFINE、BUILD、SHIP 四模式、后端 adapter、artifact gate、accepted-contract package、free-form `progress.txt`、可选 `formal-task-board.md` notes、review/repair/closeout |
