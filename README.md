...
| Skill | 说明 |
|---|---|
| `aili-delivery-flow` | AILI 交付生命周期权威：IDEATE、DEFINE、BUILD、SHIP 四模式、后端 adapter、artifact gate、共享轻量 TODO/Progress、formal package/evidence 边界、review/repair/closeout |
